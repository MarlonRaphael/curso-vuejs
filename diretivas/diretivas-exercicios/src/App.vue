<template>
    ...
    <p v-destaque:fundo="color">Usando diretiva personalizada</p>
<!--    <p v-teste:argumento.mod1.mod2.mod3="'valor'">Anatomia de uma diretiva</p>-->
    <hr>
    <p v-destaque-local:fundo.atrasar="'yellow'">Usando diretiva personalizada</p>
    <p v-destaque-local:fundo.atrasar.alternar="color">Usando diretiva personalizada</p>
    <p v-destaque-local:fundo.atrasar.alternar="{cor1: 'green', cor2: 'red', atraso: 2000, intervalo: 200}">Usando diretiva personalizada</p>
    <p v-destaque-local:fundo.atrasar="{cor1: 'red', atraso: 5000}">Usando diretiva personalizada</p>
	</div>
</template>
